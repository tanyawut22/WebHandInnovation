...
<div class="header">
  ...
  <div class="container">
    <h3 style="margin-top: 40px">จุดสัญญาณบริเวณหน้ามือ</h3>
    <h3 style="color: #DC3545; margin-bottom: 40px;">( คาบหนัก )</h3>
    <div class="row">
      ...
      <div class="column col">
        ...
        <b-alert v-if="ForcePush<25" variant="danger" show>คุณออกแรงน้อยเกินไป โปรดออกแรงกดเพิ่มขึ้น !!</b-alert>
        <!-- <b-alert v-if="timerCountDone>0" variant="success" show>คุณออกแรงได้ดีแล้ว รักษาแรงกดไว้</b-alert> -->
        <b-alert v-if="ForcePush>=25 && ForcePush<=40" variant="success" show>คุณออกแรงได้ดีแล้ว รักษาแรงกดไว้</b-alert>
        <b-alert v-if="ForcePush>40" variant="danger" show>คุณออกแรงมากเกินไป ลองผ่อนแรงอีกนิดนึง !!</b-alert>
                      ...
                      if (value == 30) {
                        this.OneSec.play();
                          // setTimeout(() => {
                            this.$fire({
                            title: "สำเร็จ!!",
                            text: "คุณกดด้วยแรง 25 - 40 กิโลกรัม เป็นเวลา 30 วินาที สำเร็จ!!",
                            type: "success",
                            // timer: 5000
                          }).then(r => {
                          console.log(r.value);
