  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <b-alert v-if="ForcePush<20" variant="danger" show><h5>คุณออกแรงน้อยเกินไป โปรดออกแรงกดเพิ่มขึ้น !!</h5></b-alert>
        <!-- <b-alert v-if="timerCountDone>0" variant="success" show>คุณออกแรงได้ดีแล้ว รักษาแรงกดไว้</b-alert> -->
        <b-alert v-if="ForcePush>=20 && ForcePush<=25" variant="success" show><h5>คุณออกแรงได้ดีแล้ว รักษาแรงกดไว้</h5></b-alert>
        <b-alert v-if="ForcePush>25" variant="danger" show><h5>คุณออกแรงมากเกินไป ลองผ่อนแรงอีกนิดนึง !!</h5></b-alert>
...
export default {
  ...
  methods: {
      ...
      fillData () {
       try {
          const docRef = setDoc(doc(firestoredb, "History", ((this.size)+1).toString()), {
            ...
            Mode: "โหมดฝึกฝนการกดด้วยแรง 20-25 กิโลกรัม เป็นเวลา 60-75 วินาที",
      ...
      alertStart(){
        Swal.fire({
          title: "กดด้วยแรง 20-25 กิโลกรัม เป็นเวลา 60-75 วินาที",
          text: "จะเริ่มใน...",
          timer: 3000,
                        ...
                        // if (value > 0 ) {
                          if (value == 60) {
                            this.OneSec.play();
                              ...
                              Swal.fire({
                                title: "สำเร็จ!!",
                                text: "คุณกดด้วยแรง 20-25 กิโลกรัม เป็นเวลา 60-75 วินาที สำเร็จ!!",
                                type: "success",
                                // timer: 5000
                              }).then(r => {
                              console.log(r.value);
