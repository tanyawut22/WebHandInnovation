  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="column col">
        ...
        <b-alert v-if="ForcePush<15" variant="danger" show>คุณออกแรงน้อยเกินไป โปรดออกแรงกดเพิ่มขึ้น !!</b-alert>
        <!-- <b-alert v-if="timerCountDone>0" variant="success" show>คุณออกแรงได้ดีแล้ว รักษาแรงกดไว้</b-alert> -->
        <b-alert v-if="ForcePush>=15 && ForcePush<=20" variant="success" show>คุณออกแรงได้ดีแล้ว รักษาแรงกดไว้</b-alert>
        <b-alert v-if="ForcePush>20" variant="danger" show>คุณออกแรงมากเกินไป ลองผ่อนแรงอีกนิดนึง !!</b-alert>
                      ...
                      if (value == 30) {
                        this.OneSec.play();
                          // setTimeout(() => {
                            this.$fire({
                            title: "สำเร็จ!!",
                            text: "คุณกดด้วยแรง 15 - 20 กิโลกรัม เป็นเวลา 30 วินาที สำเร็จ!!",
                            type: "success",
                            // timer: 5000
                          }).then(r => {
                          console.log(r.value);
