...
<div class="header">
  ...
  <div class="container">
    ...
    <h3 style="color: #3DFF50; margin-bottom: 40px;">( คาบกลาง )</h3>
    <div class="row">
      <div class="col-sm-6">
...
export default {
  ...
  methods: {
      ...
      alertStart(){
        Swal.fire({
          title: "กดด้วยแรง 20-25 กิโลกรัม เป็นเวลา 10-15 วินาที",
          text: "จะเริ่มใน...",
          timer: 3000,
                ...
                handler(value) {
                        // if (value[value.length-1]>0){
                          if (this.StatusPush==true && value==0){
                            Swal.fire({
                                title: "สำเร็จ!!",
                                text: "คุณกดด้วยแรง 20-25 กิโลกรัม เป็นเวลา 10-15 วินาที สำเร็จ!!",
                                type: "success",
                              }).then(r => {
                              console.log(r.value);
                              this.fillData()
