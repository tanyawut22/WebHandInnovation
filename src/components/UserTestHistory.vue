...
export default {
  ...
  data() {
        ...
        methods: {
          ...
          // },
          getAllDoc(user) {
              const q = query(collection(firestoredb, "Students", user.email.split("@")[0],"TestHistory"));
        ...
        getChart(selectedValue){
          // this.DocIDSize()
              onSnapshot(doc(firestoredb, "Students", this.StudentID.toString(), "TestHistory", selectedValue), (doc) => {
